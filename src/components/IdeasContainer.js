...
class IdeasContainer extends Component {
  ...
  componentDidMount() {
    axios.get('http://ideaboard-api.herokuapp.com/api/v1/ideas.json')
    .then(response => {
  ...
  addNewIdea = () => {
    axios.post('http://ideaboard-api.herokuapp.com/api/v1/ideas', {idea: {title: '', body: ''}})
    .then(response => {
  ...
  deleteIdea = (id) => {
    axios.delete(`http://ideaboard-api.herokuapp.com/api/v1/ideas/${id}`)
    .then(response => {
